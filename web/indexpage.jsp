...
.parallax {
    ...
    background-image: url("back.gif"),url("back2.gif");
    min-height: 500px; 
...
<input type="submit" id="search" value="login" >
 <input type="checkbox" style="margin:26px 30px;"> Remember me
      <a href="register.html" style="text-decoration:none; float:right; margin-right:34px; margin-top:26px;">Don't have an account</a>
